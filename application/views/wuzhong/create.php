...
<div id="content">
    ...
    echo form_open('wuzhong/create',$attributes); ?>
	...
	<div class="container-fluid">
        ...
        <tr>  
            ...
            <td><textarea name="tezheng"></textarea></td>   
        </tr> 
        <tr>  
        ...
        <tr>  
            ...
            <td><textarea name="fangshengdidian"></textarea></td>   
        </tr> 
        <tr>  
            <td><label class="control-label" for="input01">买生价格</label></td>  
            <td><textarea name="jiage"></textarea></td>   
        </tr> 
        <tr>  
