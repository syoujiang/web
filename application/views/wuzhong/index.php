...
<div id="content">
  <div class="container-fluid">
    <legend>放生物种类别管理</legend>
    <a class="btn btn-primary" href="<?php echo site_url("wuzhong/create") ?>">添加</a>
    ...
    <table class="table table-striped table-bordered table-condensed">
      <tbody>
        ...
        <tr>
            ...
            <td><?php echo anchor('wuzhong/edit/'.$news_item['id'],$index); $index++?></td>
            <td><?php echo $news_item['name'] ?></td>
            <td><?php echo anchor_popup('wuzhong/show/'.$news_item['id'],'预览'); ?></td>
        </tr>
      <?php endforeach ?>
      </tbody>
