...
<div id="content">
  <div class="container-fluid">
  	 <legend>放生管理</legend>
<a class="btn btn-primary" href="<?php echo site_url("fangsheng/create") ?>">添加</a>
...
<?php foreach ($news as $news_item): ?>
	...
	<td><?php echo anchor('fangsheng/update/'.$news_item['id'],$index_id); $index_id++;?></td>
	<td><?php echo mb_substr($news_item['title'],0,10); ?></td>
	<td><?php echo $news_item['kaishi'];?></td>
	<td><?php echo $news_item['kaishi_time'] ?></td>
    <td><?php echo mb_substr($news_item['summary'],0,10); ?></td>
	<td><?php echo anchor_popup('fangsheng/show/'.$news_item['id'],'预览'); ?></td>
