...
<?php foreach ($news as $news_item): ?>
	...
	<td><?php echo anchor('news/update/'.$news_item['id'],$index_id); $index_id++;?></td>
	<td><?php echo mb_substr($news_item['zx_title'],0,10); ?></td>
	<td><?php  foreach ($news_type as $type) {
                # code...
                    if($type['id'] == $news_item['zx_type'])
                    {
                        echo $type['news_type'];
                        break;
                    }
...
<!-- 	<td><?php echo $news_item['zx_create'] ?></td> -->
	...
	<td><?php echo mb_substr($news_item['zx_date'],0,10); ?></td>
	</tr>
<?php endforeach ?>
</tbody>
</table>
