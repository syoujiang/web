...
<div id="content">
	...
	<div class="container-fluid">
        ...
        <tr>  
            ...
            <td><textarea id="zx_summary" name="zx_summary"  onkeydown='countChar("zx_summary","counter");' onkeyup="countChar('zx_summary','counter')"></textarea><p>字数:<span id="counter">0</span>个</p></td>       
        </tr>  
        <tr>  
            <td>上传摘要图片</td>  
            <td>
