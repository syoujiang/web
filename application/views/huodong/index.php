...
<div id="content">
  <div class="container-fluid">
  	 <legend>活动详情</legend>
<a class="btn btn-primary" href="<?php echo site_url("huodong/create") ?>">添加</a>
...
<?php foreach ($news as $news_item): ?>
	...
	<td><?php echo anchor('huodong/update/'.$news_item['id'],$index_id); $index_id++;?></td>
	<td><?php echo mb_substr($news_item['title'],0,20); ?></td>
	<td><?php echo $news_item['gg_date'];?></td>
	<td><?php echo $news_item['didian'] ?></td>
	<td><?php echo anchor_popup('huodong/show/'.$news_item['id'],'预览'); ?></td>
